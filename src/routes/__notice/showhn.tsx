...
export function ShowHNRulesPage(): JSX.Element {
  return (
    <NoticeLayout>
      ...
      <p>
        The current Show HNs can be found via <Link to="/show">show</Link> in the top bar, and the
        newest are <Link to="/shownew">here</Link>. To post one, simply{' '}
        <Link to="/submit">submit</Link> a story whose title begins with "Show HN".
      </p>
      <p>
        <b>What to Submit</b>
      </p>
