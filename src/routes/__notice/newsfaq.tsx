...
export function NewsFaqPage(): JSX.Element {
  return (
    <NoticeLayout>
      ...
      <p>
        <Link to="/newsguidelines">https://news.ycombinator.com/newsguidelines</Link>
      </p>
      <p>
      ...
      <p>
        ...
        <Link to="/submitted?id=whoishiring">whoishiring</Link> is allowed to submit the thread
        itself. This prevents a race to post it first.)
      </p>
      <p>
      ...
      <p>
        ...
        <Link to="/forgot?id=">here</Link>. If you haven&#39;t, you can create a new account or
        email hn@ycombinator.com for help.
      </p>
      <p>
      ...
      <p>
        ...
        <Link to="/item?id=4761102">self-serve unbanning procedure</Link> works most of the time.
      </p>
      <p>
        <br />
        <br />
