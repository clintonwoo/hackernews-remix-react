...
export function NewsWelcomePage(): JSX.Element {
  return (
    <NoticeLayout>
      ...
      <br />
      <p>
        <Link to="/">Hacker News</Link> is a bit different from other community sites, and we&#39;d
        appreciate it if you&#39;d take a minute to read the following as well as the{' '}
